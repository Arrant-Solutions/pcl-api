...
var FavoriteService = /** @class */ (function (_super) {
    __extends(FavoriteService, _super);
    function FavoriteService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    FavoriteService.prototype.insert = function (model, withID) {
    ...
    FavoriteService.prototype.insertMany = function (models, withID) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
