...
var userController = /** @class */ (function () {
    ...
    userController.prototype.getAll = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, services_1.userService.findAll()];
                    case 1:
    ...
    userController.prototype.getOne = function (id, request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, statusCode, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, services_1.userService.findById(id)];
                    case 1:
                        _a = _b.sent(), statusCode = _a.statusCode, data = _a.data;
                        return [2 /*return*/, response.status(statusCode).json({ statusCode: statusCode, data: data })];
                }
    ...
    userController.prototype.post = function (user, request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, statusCode, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, services_1.userService.insert(user)];
                    case 1:
                        _a = _b.sent(), statusCode = _a.statusCode, data = _a.data;
                        return [2 /*return*/, response.status(statusCode).json({ statusCode: statusCode, data: data })];
                }
    ...
    userController.prototype.put = function (id, user, request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, statusCode, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, services_1.userService.update(id, user)];
                    case 1:
                        _a = _b.sent(), statusCode = _a.statusCode, data = _a.data;
                        return [2 /*return*/, response.status(statusCode).json({ statusCode: statusCode, data: data })];
                }
