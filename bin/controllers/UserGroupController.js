...
var userGroupController = /** @class */ (function () {
    function userGroupController() {
    }
    userGroupController.prototype.getAll = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, statusCode, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, services_1.userGroupService.findAll()];
                    case 1:
    ...
    userGroupController.prototype.getOne = function (id, request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, statusCode, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, services_1.userGroupService.findById(id)];
                    case 1:
                        _a = _b.sent(), statusCode = _a.statusCode, data = _a.data;
                        return [2 /*return*/, response.status(statusCode).json({ statusCode: statusCode, data: data })];
                }
    ...
    userGroupController.prototype.post = function (userGroup, request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, statusCode, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, services_1.userGroupService.insert(userGroup)];
                    case 1:
                        _a = _b.sent(), statusCode = _a.statusCode, data = _a.data;
                        return [2 /*return*/, response.status(statusCode).json({ statusCode: statusCode, data: data })];
                }
    ...
    userGroupController.prototype.put = function (id, userGroup, request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, statusCode, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, services_1.userGroupService.update(id, userGroup)];
                    case 1:
                        _a = _b.sent(), statusCode = _a.statusCode, data = _a.data;
                        return [2 /*return*/, response.status(statusCode).json({ statusCode: statusCode, data: data })];
                }
    ...
    userGroupController.prototype.remove = function (id, request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, statusCode, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, services_1.userGroupService.deleteById(id)];
                    case 1:
                        _a = _b.sent(), statusCode = _a.statusCode, data = _a.data;
                        return [2 /*return*/, response.status(statusCode).json({ statusCode: statusCode, data: data })];
                }
