...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.update = function (user, request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, statusCode, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, services_1.authService.update(request.user.user_id, user)];
                    case 1:
                        _a = _b.sent(), statusCode = _a.statusCode, data = _a.data;
                        return [2 /*return*/, response.status(statusCode).json({ statusCode: statusCode, data: data })];
                }
    ...
    __decorate([
        (0, routing_controllers_1.Put)('/auth/:user_id'),
